...
public class Delivery_PendingOrder_View extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerViewdish.setLayoutManager(new LinearLayoutManager(Delivery_PendingOrder_View.this));
    ...
    private void deliveryorders() {
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter = new DeliveryPendingOrderViewAdapter(Delivery_PendingOrder_View.this, deliveryShipOrdersList);
