...
public class Delivery_shipOrder_View extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerViewdish.setLayoutManager(new LinearLayoutManager(Delivery_shipOrder_View.this));
    ...
    private void deliveryfinalorders() {
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter = new DeliveryShipOrderViewAdapter(Delivery_shipOrder_View.this, deliveryShipFinalOrdersList);
