...
public class ChefForgotPassword extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        forgotpassword = (TextInputLayout) findViewById(R.id.Emailid);
                ...
                FAuth.sendPasswordResetEmail(forgotpassword.getEditText().getText().toString()).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            mDialog.dismiss();
                            ResuableCodeForAll.ShowAlert(ChefForgotPassword.this,"","Password has been sent to your Email");
                        } else {
                            mDialog.dismiss();
                            ResuableCodeForAll.ShowAlert(ChefForgotPassword.this, "Error", task.getException().getMessage());
                        }
                    }
                });
            }
