...
public class Chef_Prepared_Order_View extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(Chef_Prepared_Order_View.this);
        progressDialog.setCanceledOnTouchOutside(false);
        progressDialog.setCancelable(false);
        recyclerViewdish.setHasFixedSize(true);
        recyclerViewdish.setLayoutManager(new LinearLayoutManager(Chef_Prepared_Order_View.this));
    ...
    private void CheforderdishesView() {
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                ...
                                                                public void onSuccess(Void aVoid) {
                                                                    FirebaseDatabase.getInstance().getReference().child("Tokens").child(deliveryId).child("token").addListenerForSingleValueEvent(new ValueEventListener() {
                                                                        ...
                                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                            ...
                                                                            AlertDialog.Builder builder = new AlertDialog.Builder(Chef_Prepared_Order_View.this);
                                                                            ...
                                                                            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                                                                ...
                                                                                public void onClick(DialogInterface dialog, int which) {
                                                                                    ...
                                                                                    dialog.dismiss();
                                                                                    Intent b = new Intent(Chef_Prepared_Order_View.this, Chef_Prepared_Order.class);
                                                                                    startActivity(b);
                                                                                    finish();
                ...
                adapter = new ChefPreparedOrderViewAdapter(Chef_Prepared_Order_View.this, chefFinalOrdersList);
            ...
            public void onResponse(Call<MyResponse> call, Response<MyResponse> response) {
                if (response.code() == 200) {
                    if (response.body().success != 1) {
                        Toast.makeText(Chef_Prepared_Order_View.this, "Failed", Toast.LENGTH_SHORT).show();
                    }
                }
