...
public class Chef_Order_Tobe_Prepared_View extends AppCompatActivity {

    RecyclerView recyclerViewdish;
    private List<Chef> chefWaitingOrdersList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chef_order_tobe_prepared_view);
        ...
        progressDialog = new ProgressDialog(Chef_Order_Tobe_Prepared_View.this);
        progressDialog.setCanceledOnTouchOutside(false);
        progressDialog.setCancelable(false);
        recyclerViewdish.setHasFixedSize(true);
        recyclerViewdish.setLayoutManager(new LinearLayoutManager(Chef_Order_Tobe_Prepared_View.this));
                                                                        ...
                                                                        public void onSuccess(Void aVoid) {
                                                                            ...
                                                                            FirebaseDatabase.getInstance().getReference().child("Tokens").child(userid).child("token").addListenerForSingleValueEvent(new ValueEventListener() {
                                                                                ...
                                                                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                                    ...
                                                                                    AlertDialog.Builder builder = new AlertDialog.Builder(Chef_Order_Tobe_Prepared_View.this);
                                                                                    ...
                                                                                    builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                                                                        ...
                                                                                        public void onClick(DialogInterface dialog, int which) {
                                                                                            ...
                                                                                            dialog.dismiss();
                                                                                            Intent b = new Intent(Chef_Order_Tobe_Prepared_View.this, Chef_Order_Tobe_Perpared.class);
                                                                                            startActivity(b);
                                                                                            finish();
