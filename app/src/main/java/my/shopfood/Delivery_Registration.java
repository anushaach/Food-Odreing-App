...
public class Delivery_Registration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Statespin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (statee.equals("NepaliFood")) {
                    ...
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Delivery_Registration.this, android.R.layout.simple_spinner_item);
        ...
        phone.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent e = new Intent(Delivery_Registration.this, Delivery_Login.class);
                startActivity(e);
                finish();
            }
        });
